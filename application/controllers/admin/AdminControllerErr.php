...
class AdminControllerErr extends ParentAdminController
{
    public $error;
    public $route;
    ...
    public function __construct($fc, $route, $file_layout,  $error, $errno, $errstr, $errfile, $errline, $response = 500 )
    {
